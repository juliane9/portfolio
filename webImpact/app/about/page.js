    ...
    <div className="bg-gradient-to-bl from-gray-900 via-black to-gray-800 min-h-screen text-gray-100 px-6 py-12 font-mono">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-200"> <span className="text-4xl">🎓</span> Education</h2>
        ...
        {/* Section: Interests */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-200"><span className="text-4xl">✨</span> Interests</h2>
          <p className="text-gray-300 text-justify">
        ...
        {/* Section: Past */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-200"><span className="text-4xl">💼</span> Past experiences</h2>
          <p className="text-gray-300 text-justify">
